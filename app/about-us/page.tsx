...
<section id="profile" className="relative overflow-hidden bg-[#F8FAFC] py-20 lg:py-28 scroll-mt-24">
  <div id="management" className="mx-auto max-w-7xl px-6 lg:px-10">
...
<section className="relative overflow-hidden bg-bg py-24 md:py-32">
  ...
  <div className="container-px relative">
    ...
    >
      ...
      <section id="vision-mission" className="section-py bg-bg scroll-mt-24">

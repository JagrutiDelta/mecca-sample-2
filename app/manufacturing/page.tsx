      ...
      <section className="section-py bg-white border-y border-border">
        <div className="container-px">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-base md:text-lg text-gray leading-relaxed">
              From engineering precision metal aircraft rivets in 1972 to manufacturing millions of
              sterile infusion sets and medical devices daily.
            </p>
          </div>

          <div className="relative max-w-4xl mx-auto">
            {/* Center Vertical Gradient Line */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-burgundy via-border to-transparent -translate-x-1/2" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 md:px-8">
                      <div className="p-6 rounded-xl2 bg-slate-50 border border-border hover:border-burgundy/30 transition-colors shadow-sm">
                        <div className="inline-block px-3 py-1 rounded-full bg-burgundy-gradient text-white font-heading font-bold text-xs mb-3 shadow-xs">
                          {m.year}
                        </div>
                    ...
                    {/* Timeline Node Dot */}
                    <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-white border-2 border-burgundy items-center justify-center shadow-sm">

...
const DOWNLOAD_ITEMS = [
  {
    ...
    items: [
      ...
      {
        title: "Mecca Labs Pharmaceutical Product Catalogue",
        desc: "Sterile pre-filled syringes, beta-lactam antibiotics, oral liquids, tablets, dry syrups, and IV infusions.",
        file: "/mecca-labs/pharmaceutical",
        isLink: true,
      ...
      {
        title: "Mecca Labs Domestic Nutraceutical Catalogue",
        desc: "FSSAI-registered dietary supplements, omega-3, calcium, vitamins, and protein powders.",
        file: "/mecca-labs/domestic",
        isLink: true,
        format: "Interactive / PDF",
        size: "View Online",
      ...
      {
        title: "Mecca Labs Export Nutraceutical Catalogue",
        desc: "Global export grade vitamins, botanical supplements, tablets, capsules, and syrups.",
        file: "/mecca-labs/export",
        isLink: true,
        format: "Interactive / PDF",
        size: "View Online",
        badge: "Export cGMP",
      ...
      {
        title: "Mecca Labs Milk Products Catalogue",
        desc: "Infant milk formula stages 1-3, maternal nutrition, baby cereals, and whey protein isolates.",
        file: "/mecca-labs/milk",
        isLink: true,
        format: "Interactive / PDF",
        size: "View Online",
      ...
      {
        title: "Mecca Labs Cosmeceutical Products Catalogue",
        desc: "Human intimate care hygiene, therapeutic skin care, and La Splendra aesthetic beauty range.",
        file: "/mecca-labs/cosmeceutical",
        isLink: true,
        format: "Interactive / PDF",
        size: "View Online",
        badge: "ISO 22716 GMP",

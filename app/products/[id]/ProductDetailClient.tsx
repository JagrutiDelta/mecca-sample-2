          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="py-3 px-6 rounded-full bg-burgundy-gradient text-white text-xs sm:text-sm font-bold shadow-soft hover:shadow-card hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className={`py-3 px-5 rounded-full text-xs sm:text-sm font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer ${
                  isItemInQuote(product.name)
                    ? "bg-emerald-50 text-emerald-700 border border-emerald-300 font-bold"
                    : "bg-slate-100 hover:bg-slate-200 text-navy border border-slate-200"
                }`}
                title={
                  isItemInQuote(product.name)
                ...
                >
                  ...
                  <div className="pt-4 border-t border-border/60 flex items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        addToQuote(rel.name);
                        openQuoteModal(rel.name);
                      }}
                      className="py-2.5 px-3.5 rounded-full bg-burgundy text-white font-semibold text-xs hover:bg-burgundy-dark transition-colors shadow-sm flex items-center gap-1 cursor-pointer"
                    >
